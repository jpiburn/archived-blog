...
# knitr::kable(head(wbstats::wb_cachelist$indicators[2000:2005, ]))
library(knitr)
library(kableExtra)
options(knitr.table.format = "html")

kable(wbstats::wb_cachelist$indicators[2000:2005, ]) %>% 
...
```{r vig-ex-posixct-2, fig.height = 4, fig.width = 7.5}
library(wbstats)
library(ggplot2)
